...
/// 访客内 glibc 版 `cargo`/`rustc` 在复杂初始化阶段栈消耗大；8MiB 易触发 `-fstack-protector` 误报式崩溃。
pub const USER_STACK_SIZE: usize = 0x200_0000; // 32 MiB
...
pub const USER_HEAP_SIZE_MAX: usize = 0x8000_0000;
