...
pub fn check_crate_name(name: &str) -> bool {
...
pub fn check_app_name(name: &str) -> bool {
    Path::new(&(APP_ROOT.to_string() + name)).exists()
}

pub fn check_lib_name(name: &str) -> bool {
    Path::new(&(ULIB_ROOT.to_string() + name)).exists()
}

pub fn is_arceos_crate(name: &str) -> bool {
...
pub fn build_loc(name: &str) -> String {
