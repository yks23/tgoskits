...
TGOSKits 由长期参与 ArceOS、StarryOS、Axvisor 及相关共享组件演进的开发者共同维护。以下列出当前工作区中的核心参与者与活跃贡献者：
...
我们感谢所有为 TGOSKits 及相关系统路径做出贡献的开发者！
...
完整的贡献者列表请查看我们的 [GitHub 贡献者页面](https://github.com/rcore-os/tgoskits/graphs/contributors)。
...
| 目的 | 联系方式 | 说明 |
|------|----------|------|
| 一般咨询 | [GitHub Issues](https://github.com/rcore-os/tgoskits/issues) | 项目相关的一般问题 |
| 仓库协作 | [GitHub 仓库](https://github.com/rcore-os/tgoskits) | 代码、文档与开发入口 |
